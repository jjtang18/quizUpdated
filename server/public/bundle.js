    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a2, file, 28, 4, 570);
    			add_location(code0, file, 30, 4, 647);
    			add_location(code1, file, 32, 4, 695);
    			add_location(code2, file, 34, 4, 753);
    			attr_dev(a3, "href", "https://nodejs.org/en/");
    			add_location(a3, file, 36, 4, 807);
    			add_location(code3, file, 39, 6, 901);
    			attr_dev(a4, "href", "/api/date");
    			add_location(a4, file, 38, 4, 874);
    			add_location(p0, file, 20, 2, 389);
    			add_location(br, file, 44, 2, 983);
    			add_location(h21, file, 45, 2, 992);
    			add_location(p1, file, 46, 2, 1037);
